...
\Chris{For table \ref{table:rnn-throughput} how many layers and what was hidden size?}
...
\Chris{Put title on Figure \ref{fig:tp_perf}}
...
a few hours \Chris{how many?} of training.
