...
\begin{figure}
  ...
  \begin{minipage}{0.5\textwidth}
    \includegraphics[width=1.0\textwidth]{./between_chain_plots/1k_20_smoothing.png}
  \end{minipage}%
    \begin{minipage}{0.5\textwidth}
    \includegraphics[width=1.0\textwidth]{./between_chain_plots/8k_5_smoothing.png}
  \end{minipage}
  \begin{minipage}{0.5\textwidth}
    \includegraphics[width=1.0\textwidth]{./between_chain_plots/1m_20_smoothing.png}
  \end{minipage}
