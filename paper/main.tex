...
\ref{fig:tp_perf}.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% The computational performance of the LSTM and LS-LSTM models were compared       %
% across a wide range of minibatch sizes and sequence lengths. Although the 234    %
% unit LS-LSTM has a similar number of parameters to the 256 unit LSTM, we         %
% measured the computational performance of a 256 unit LS-LSTM to observe any      %
...
% sequence length causes a doubling of runtime. Notably, the LS-LSTM can achieve a %
...
\begin{figure}
  ...
  \end{minipage}
  \caption{Training curves for LS-LSTM and CUDNNLSTM architectures for various
  sequence lengths.}
...
0.278 \(\pm\) 0.083 & 0.0314 \(\pm\) 0.0019 & 0.58 \(\pm\) 0.06 & 0.10 \(\pm\) 0.03
